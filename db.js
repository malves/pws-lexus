...
db.exec(`
  CREATE TABLE IF NOT EXISTS submissions (
    ...
    page         TEXT,                       -- LBX | NX | CHR | CHR_PLUS | CHR_VIDEO | YARIS
    page_url     TEXT,
    civilite     TEXT,
    prenom       TEXT,
    nom          TEXT,
...
// --------------------------------------------------------------------------
const DATABOWL_PAGES = ["LBX", "NX", "CHR", "CHR_PLUS", "CHR_VIDEO", "YARIS"];
const DEFAULT_DATABOWL_SETTINGS = {
  ...
  CHR_VIDEO: { campaign: "701Sa00002enXXV", cid: "364", sid: "1189" },
